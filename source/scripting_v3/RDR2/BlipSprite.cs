...
namespace RDR2
{
	public enum BlipSprite
	{
		...
		JerryCan2 = 415,
		RP = 416,
		RDR2OPlayerSafehouse = 417,
		/// <summary>
		/// In RDR2 Online, when some player is a bounty and is in a safehouse, a blip with this sprite will be attached.
		/// </summary>
		RDR2OPlayerSafehouseDead = 418,
		...
		DollarBill,
		/// <summary>
		/// The default English text for this value is "Package", whose label text hash is used in Biker Business missions in RDR2 Online.
		/// </summary>
		Package2,
		Capture1,
		Capture2,
